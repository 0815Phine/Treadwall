...
for currentTrial = 1:S.GUI.MaxTrialNumber
    ...
    if currentTrial == 1
        ...
        sma = AddState(sma, 'Name', 'z1f',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z2f', 'AnalogIn1_3', 'z1b', 'SoftCode1', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', stimOutput{1}});
        sma = AddState(sma, 'Name', 'z1b',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z4bb', 'AnalogIn1_2', 'z1f', 'SoftCode1', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', stimOutput{1}});

        % zone 2
        sma = AddState(sma, 'Name', 'z2f',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z3f', 'AnalogIn1_3', 'z2b', 'SoftCode1', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', stimOutput{2}});
        sma = AddState(sma, 'Name', 'z2b',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z1b', 'AnalogIn1_2', 'z2f', 'SoftCode1', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', stimOutput{2}});
        sma = AddState(sma, 'Name', 'z2fb',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z3fb', 'AnalogIn1_3', 'z2bb', 'SoftCode1', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', stimOutput{2}});
        sma = AddState(sma, 'Name', 'z2bb',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z1b', 'AnalogIn1_2', 'z2fb', 'SoftCode1', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', stimOutput{2}});

        % zone 3
        sma = AddState(sma, 'Name', 'z3f',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z4f', 'AnalogIn1_3', 'z3b', 'SoftCode1', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', stimOutput{3}});
        sma = AddState(sma, 'Name', 'z3b',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z2b', 'AnalogIn1_2', 'z3f', 'SoftCode1', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', stimOutput{3}});
        sma = AddState(sma, 'Name', 'z3fb',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z4fb', 'AnalogIn1_3', 'z3bb', 'SoftCode1', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', stimOutput{3}});
        sma = AddState(sma, 'Name', 'z3bb',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z2bb', 'AnalogIn1_2', 'z3fb', 'SoftCode1', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', stimOutput{3}});

        % zone 4: exit trial after completing zone 4
        sma = AddState(sma, 'Name', 'z4f',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','exit', 'AnalogIn1_3', 'z4b', 'SoftCode1', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', stimOutput{4}});
        sma = AddState(sma, 'Name', 'z4b',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z3b', 'AnalogIn1_2', 'z4f', 'SoftCode1', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', stimOutput{4}});
        sma = AddState(sma, 'Name', 'z4fb',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z1f', 'AnalogIn1_3', 'z4bb', 'SoftCode1', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', stimOutput{4}});
        sma = AddState(sma, 'Name', 'z4bb',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z3bb', 'AnalogIn1_2', 'z4fb', 'SoftCode1', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', stimOutput{4}});
    ...
    elseif currentTrial == S.GUI.MaxTrialNumber
        ...
        sma = AddState(sma, 'Name', 'z4f',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','EndBuffer', 'AnalogIn1_3', 'z4b', 'SoftCode1', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', stimOutput{4}});
        sma = AddState(sma, 'Name', 'z4b',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z3b', 'AnalogIn1_2', 'z4f', 'SoftCode1', 'EndBuffer'},...
