...
A.Thresholds(1,1:3) = [1.5, 1.75, 1.45];
A.ResetVoltages(1,1:3) = [3, 1.65, 1.65];
...
for currentTrial = 1:S.GUI.MaxTrialNumber
    ...
    if currentTrial == 1 %first trial
        ...
        sma = AddState(sma, 'Name', 'z1f',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z2f', 'AnalogIn1_3', 'z1b', 'GlobalTimer1_End', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', ['>' 5 5 255 255]});

        sma = AddState(sma, 'Name', 'z1b',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z4b', 'AnalogIn1_2', 'z1f', 'GlobalTimer1_End', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', ['>' 5 5 255 255]});


        sma = AddState(sma, 'Name', 'z2f',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z3f', 'AnalogIn1_3', 'z2b', 'GlobalTimer1_End', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', ['>' 3 3 255 255]});

        sma = AddState(sma, 'Name', 'z2b',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z1b', 'AnalogIn1_2', 'z2f', 'GlobalTimer1_End', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', ['>' 3 3 255 255]});


        sma = AddState(sma, 'Name', 'z3f',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z4f', 'AnalogIn1_3', 'z3b', 'GlobalTimer1_End', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', ['>' 4 4 255 255]});

        sma = AddState(sma, 'Name', 'z3b',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z2b', 'AnalogIn1_2', 'z3f', 'GlobalTimer1_End', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', ['>' 4 4 255 255]});


        % exit trial after completing last quarter
        sma = AddState(sma, 'Name', 'z4f',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','exit', 'AnalogIn1_3', 'z4b', 'GlobalTimer1_End', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', ['>' 2 2 255 255]});

        sma = AddState(sma, 'Name', 'z4b',...
            'Timer',0,...
            'StateChange Conditions', {'AnalogIn1_1','z3b', 'AnalogIn1_2', 'z4f', 'GlobalTimer1_End', 'EndBuffer'},...
            'OutputActions', {'WavePlayer1', ['>' 2 2 255 255]});
